...
* **Serial_log:**
    ![Initialization Log](Test_screenshots/Pasted%20image%2020260512101805.png)
...
* **Serial_log:**
    ![Slot-A Validation and Jump](Test_screenshots/Pasted%20image%2020260512103653.png)
...
2.  The slot is validated and the bootloader jumps to Slot-B else it rolls back to Slot-A.
...
* **Serial_log:**
    ![Slot-B Persistence Log](Test_screenshots/Pasted%20image%2020260512121033.png)
...
* **Serial_log:**
    ![Slot-B to Slot-A Update 1](Test_screenshots/Pasted%20image%2020260512124028.png)
    ![Slot-B to Slot-A Update 2](Test_screenshots/Pasted%20image%2020260512124155.png)
...
* **Date:** 12/05/2026
* **Objective:** To check if after manual corruption of the binary files using Cube Programmer the bootloader is able to detect fault and jump to a valid firmware or declare both firmware's as invalid.

### Part A: Both slots corrupted
After corruption of both the slots the bootloader was able to check them and declare them as invalid.

* **Serial_log:**
    ![Both Slots Invalid](Test_screenshots/Pasted%20image%2020260512130740.png)

### Part B: Slot-A corrupted
After the corruption of Slot-A the firmware mcu will rollback to Slot-B hence proving that the CRC validation is functioning.

* **Serial_log:**
    ![Slot-A Corruption Log](Test_screenshots/Pasted%20image%2020260512141422.png)
    ![Slot-A Corruption Verification](Test_screenshots/Pasted%20image%2020260512141728.png)

### Part C: Slot-B corrupted
After the corruption of Slot-B firmware mcu will rollback to Slot-A hence proving that the CRC validation is functioning.

* **Serial_log:**
    ![Slot-B Corruption Log](Test_screenshots/Pasted%20image%2020260512141956.png)
    ![Slot-B Corruption Verification](Test_screenshots/Pasted%20image%2020260512142059.png)
...
### Part A: Slot-A MSP Corruption
After the corruption of MSP in slot-A the bootloader rolls to the Slot-B application. In the Cube programmer image one can see the MSP doesn't have the starting address of the SRAM (0x20020000).

* **Serial_log:**
    ![Slot-A MSP Error Log](Test_screenshots/Pasted%20image%2020260512145035.png)
    ![Slot-A MSP CubeProgrammer Register Status](Test_screenshots/Pasted%20image%2020260512150128.png)

### Part B: Slot-B MSP Corruption
Doing the same but for Slot-B's application.

* **Serial_log:**
    ![Slot-B MSP Error Log](Test_screenshots/Pasted%20image%2020260512151303.png)
    ![Slot-B MSP CubeProgrammer Register Status](Test_screenshots/Pasted%20image%2020260512151355.png)
...
* **Serial_log:**
    ![Interrupted OTA Connection Drop](Test_screenshots/Pasted%20image%2020260512174621.png)
    ![Interrupted OTA Recovery Success](Test_screenshots/Pasted%20image%2020260512174700.png)
...
* **Serial_log:**
    ![Corrupted Chunks Rejection Log](Test_screenshots/Pasted%20image%2020260513092550.png)
...
1.  We use the console logs from STM32 Cube IDE and also the memory utilization console to check the amount of flash memory allocated to the bootloader, applications and check how much is utilized by each.
